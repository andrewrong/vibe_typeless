...
- **金融术语**：保留所有金融/交易相关英文术语，如：
  - 期权术语：sell put, sell call, buy put, buy call, covered call, naked put
  - 股票术语：long, short, bullish, bearish, strike price, expiration, premium
  - 其他：dividend, yield, margin, leverage, delta, gamma, theta, vega
- **代码和命令**：保持原样，不格式化
